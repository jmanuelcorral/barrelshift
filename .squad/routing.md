...
|-----------|----------|----------|
| Game architecture | Mikey | System design, module structure, game loop architecture |
| Game engine & mechanics | Data | Physics, collision, player movement, enemy AI, state management |
| Rendering & visuals | Brand | Canvas setup, sprites, animations, UI/HUD, audio, screens |
| Code review | Mikey | Review PRs, check quality, suggest improvements |
| Testing | Mouth | Write tests, find edge cases, verify fixes, performance profiling |
