...
3. **Merge the decision inbox** — read `.squad/decisions/inbox/`, append to `.squad/decisions.md`, delete inbox files
...
6. **Commit** — `git add .squad/ && commit` (write msg to temp file, use -F). Skip if nothing staged.
